...
class _PhotosGridState extends State<PhotosGrid> {
  ...
  final editProfileProvider =
      navigatorKey.currentContext!.read<EditProfileProvider>();
    ...
    if (index < serverImages.length) {
      return Stack(
        ...
        children: [
          ...
          CustomIconBtn(
              onTap: () {
                editProfileProvider.deletedImages
                    .add(serverImages[index]['id']);
      ...
      return (index - serverImages.length < pickedImages.length - 1)
          ? Container(
              decoration: BoxDecoration(
                ...
                image: DecorationImage(
                    image:
                        FileImage(pickedImages[index - serverImages.length]!),
                    fit: BoxFit.cover),
              ),
            )
