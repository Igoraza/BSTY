...
class _PersonDetailedPageState extends State<PersonDetailedPage> {
  ...
  void initState() {
    super.initState();
    personProfileFuture = context
        .read<PeopleProvider>()
        .fetchPersonProfile(context, widget.userId);
  }
    ...
    final List userActionButtons = [
      {
        ...
        'onTap': () {
          ...
          if (swipesBalance != 0 || !planExpired) {
            peopleProvider
                .sendUserAction(context, widget.userId, '1')
                .then((res) {
        ...
        'onTap': () {
          ...
          if (userPlan > 2 && !planExpired) {
            if (superLikesBalance == 0) {
              ...
              peopleProvider
                  .sendUserAction(context, widget.userId, '2')
                  .then((value) {
                if (value['status']) {
            ...
            showDialog(
                context: context, builder: (context) => UpgradePlanDialog());
            return;
          }
        },
      },
                  ...
                  return ColoredBox(
                    ...
                    child: Column(
                        ...
                        children: [
                          ...
                          Padding(
                            padding: EdgeInsets.all(appHeight * 0.03)
                                .copyWith(top: 0),
                            child: Column(children: [
                              ...
                              const Divider(
                                  height: 40, color: AppColors.lightGrey),
                              reportButton,
                              const Divider(
                                  height: 40, color: AppColors.lightGrey),
                              Row(
