...
class _FilterBottomSheetState extends State<FilterBottomSheet> {
  ...
  List<Map<String, dynamic>> genders = [
    {'name': 'Men', 'icon': FontAwesomeIcons.mars, 'value': '1'},
    {'name': 'Women', 'icon': FontAwesomeIcons.venus, 'value': '2'},
    {'name': 'Everyone', 'icon': FontAwesomeIcons.venusMars, 'value': '3'},
  ];
  Map<String, String> plans = {'1': 'Basic', '2': 'Plus', '3': 'Both'};
                    ...
                    children: plans.entries
                        .map(
                          (e) => StadiumButton(
                            onPressed: () {
                              debugPrint(
                                Hive.box('user').get('plan').toString(),
                              );
