...
class UpgradePlanDialog extends StatefulWidget {
  String? title;
  UpgradePlanDialog({Key? key, this.title}) : super(key: key);

  @override
  State<UpgradePlanDialog> createState() => UpgradePlanDialogState();
}

class UpgradePlanDialogState extends State<UpgradePlanDialog> {
    ...
    return Dialog(
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            Text(
              'Upgrade to BSTY ${widget.title ?? 'Plus'}',
                    ...
                    builder: (context, value, child) {
                      if (widget.title != null) {
                        return ListView.builder(
                          itemCount: planPriceDet.payOptionsPre.length,
                          scrollDirection: Axis.horizontal,
                          itemBuilder: (BuildContext context, int index) {
                            // String price =
                            //     _products[index].rawPrice.toString();
                            // log(_products[index].id.toString());
                            return GestureDetector(
                              onTap: () {
                                // log(_selectedPlan.value.toString());
                              ...
                              child: Container(
                                ...
                                padding: EdgeInsets.symmetric(
                                  vertical: index == 1 ? 0 : mq.height * 0.02,
                                ),
                                decoration: BoxDecoration(
                                  border: Border.all(
                                ...
                                child: Column(
                                  children: [
                                    ...
                                    Text(
                                      planPriceDet.payOptionsPre[index]['plan']
                                          .toString(),
                                      textAlign: TextAlign.center,
                                      style: Theme.of(context)
                                          .textTheme
                                    ...
                                    Text(
                                      'USD ${planPriceDet.payOptionsPre[index]['price']}',
                                      textAlign: TextAlign.center,
              ...
              onPressed: () async {
                ...
                await initStoreInfo({
                  widget.title == null
                      ...
                      : planPriceDet.payOptionsPre[_selectedPlan.value]['id'],
                });
                String planId = widget.title == null
                    ? planPriceDet.payOptionsPlus[_selectedPlan.value]['id']
                    : planPriceDet.payOptionsPre[_selectedPlan.value]['id'];
                if (_notFoundIds.isNotEmpty && _notFoundIds[0] == planId) {
                  navigatorKey.currentState!.pop();
                  showSnackBar(
